...
styleDeposit.init();
const loadProtocols = new LoadProtocols("http://localhost:3000", '[data-load="icon"]', '[data-load="alert"]', '[data-load="public"]', '[data-load="doc"]', '[data-load="title"]', '[data-load="depositDefeated"]', '[data-load="defeated"]', '[data-load="completed"]');
loadProtocols.init();
